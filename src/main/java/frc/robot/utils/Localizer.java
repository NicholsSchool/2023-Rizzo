...
/*
* Localizer localizes our robot/s position and angle on the field relative to (0, 0) bottom left
...
public class Localizer {
  ...
  final double[][] APRIL_TAG_LOCATIONS = new double[][] {
      { 15.51, 1.07 },
      { 15.51, 2.75 },
      { 15.51, 4.42 },
      { 16.18, 6.75 },
  ...
  /**
   * Returns a confidence from 0 --> 1 based on how accurate we believe our
  ...
  /**
   * Localize your position on the field relative to (0, 0) located in the bottom
   * left of the field
   */
  ...
  /*
   * Returns the angle (in radians) of the robot's heading relative to the field
   * with 0 degrees at the red alliance station and 180 degrees at the blue
   * alliance station.
   */
  ...
  /*
   * Returns the angle of the robot's heading with 0 degrees at the red alliance
   * station and 180 degrees at the blue alliance station. This angle is measured
   * in radians.
   */
