...
public class Test06Intake extends SequentialCommandGroup {
  ...
  public Test06Intake(SwerveDrive _swerveDrive, Intake _intake, Uprighter _uprighter, Gripper _gripper, Arm _arm) {
    ...
    // Question: Can I run the deploy intake command?
    // Answer: ran fine
    addCommands(new DeployIntake(intake, uprighter).withTimeout(4.0));
    // Questions: What happens when I chain commands this way??
    // Answer: -45 degress went upper left
