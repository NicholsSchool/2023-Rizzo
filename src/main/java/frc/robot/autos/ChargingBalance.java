...
public class ChargingBalance extends SequentialCommandGroup {
  ...
  public ChargingBalance(SwerveDrive _swerveDrive, Intake _intake, Uprighter _uprighter, Gripper _gripper, Arm _arm) {
