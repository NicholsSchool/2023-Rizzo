...
public class Test05Rotate extends SequentialCommandGroup {
  ...
  public Test05Rotate(SwerveDrive _swerveDrive, Intake _intake, Uprighter _uprighter, Gripper _gripper, Arm _arm) {
