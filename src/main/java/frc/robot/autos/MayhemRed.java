...
public class MayhemRed extends SequentialCommandGroup {
  ...
  public MayhemRed(SwerveDrive _swerveDrive, Intake _intake, Uprighter _uprighter, Gripper _gripper, Arm _arm) {
