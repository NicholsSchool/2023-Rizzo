...
public class ElectricBlue extends SequentialCommandGroup {
  ...
  public ElectricBlue(SwerveDrive _swerveDrive, Intake _intake, Uprighter _uprighter, Gripper _gripper, Arm _arm) {
