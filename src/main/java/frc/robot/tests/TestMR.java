...
// TVR Mayhem Red
public class TestMR extends SequentialCommandGroup {
  ...
  public TestMR(SwerveDrive _swerveDrive, Intake _intake, Uprighter _uprighter, Gripper _gripper, Arm _arm) {
